# OSINT Framework — Category Index

> 1084 free/freemium tools across 34 categories
...
| Disinformation & Media Verification | `disinfo-verification` | 17 |
| Blockchain & Cryptocurrency | `blockchain-crypto` | 31 |
| Classifieds | `classifieds` | 11 |
| Encoding / Decoding | `encoding-decoding` | 16 |
| Tools | `osint-tools` | 36 |
