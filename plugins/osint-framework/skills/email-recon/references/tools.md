# Email Address — OSINT Tools Reference
...
- **API**: No
- **CLI Install**: Yes
- **Best For**: Identity correlation via GitHub and PGP
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Reverse email lookup, person identification
- **Input**: Email address
...
- **API**: Yes
- **CLI Install**: N/A
- **Best For**: Business email discovery, bulk email finding
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Account enumeration, breach detection, digital footprint mapping
...
- **API**: No
- **CLI Install**: Yes
- **Best For**: Early-stage email reconnaissance, information gathering
- **Input**: Email address
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Email discovery by domain, bulk email list creation
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Corporate email pattern analysis, email format discovery
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Email pattern generation, targeted email guessing
...
- **Description**: Hosted demo of the Reach-er email verification API allowing free testing of email validation and deliverability checks online.
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Bulk blocking and threat intelligence integration for disposable email detection
...
- **API**: Yes
- **CLI Install**: N/A
- **Best For**: Infostealer detection, breach assessment, device compromise verification
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Breach research, public breach database navigation
