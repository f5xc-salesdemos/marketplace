# Domain Name — OSINT Tools Reference

> Auto-generated from arf.json. 131 free/freemium tools.
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Domain ownership history, reverse analytics lookup, competitor domain research
- **Input**: Domain name
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Historical domain ownership, reverse WHOIS lookups, domain connection tracking
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: DNS reconnaissance, IP and domain relationship mapping, historical internet data lookup
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Quick domain WHOIS lookups and DNS checks
- **Input**: Domain name
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Domain registration research, WHOIS lookups, RDAP queries, IP tracking
- **Input**: Domain name or IP address
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Mobile-friendly WHOIS lookups, quick domain information retrieval
- **Input**: Domain name
...
- **API**: Yes
- **CLI Install**: N/A
- **Best For**: Domain and IP WHOIS lookups, registrant research
- **Input**: Domain name or IP address
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Unified OSINT research, subdomain discovery, multi-vector intelligence gathering
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Automated subdomain enumeration, organization name filtering, subdomain statistics
...
- **API**: Yes
- **CLI Install**: Yes
- **Best For**: Modular web recon, API-driven data collection
...
- **API**: No
- **CLI Install**: Yes
- **Best For**: Initial domain footprinting and asset discovery
...
- **API**: No
- **CLI Install**: Yes
- **Best For**: Scriptable multi-module OSINT reconnaissance workflows
...
- **API**: No
- **CLI Install**: Yes
- **Best For**: Passive email and subdomain collection from indexed sources
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Quick browser-based subdomain discovery without local setup
- **Input**: Domain name
...
- **API**: No
- **CLI Install**: Yes
- **Best For**: Combining passive and active subdomain discovery in one tool
...
- **API**: No
- **CLI Install**: Yes
- **Best For**: CLI-driven reconnaissance against domain and host assets
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Understanding redirect paths and affiliate or cloaking behavior
- **Input**: URL
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Pivoting from shared tracking IDs to related domains
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Quick URL/domain triage and intelligence pivoting
- **Input**: URL or domain
...
- **API**: Yes
- **CLI Install**: N/A
- **Best For**: Malware/phishing analysis, URL behavior detection, deep web threat investigation
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: URL/domain dissection and reputation
- **Input**: URL or domain
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Malware domain reputation queries
- **Input**: Domain name
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: IP/domain reputation intelligence
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Malware and spyware domain research
- **Input**: Domain or URL
...
- **API**: Yes
- **CLI Install**: N/A
- **Best For**: IP/domain reputation and abuse intelligence
- **Input**: IP address or domain
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Typosquatting monitoring
- **Input**: Domain name
...
- **API**: No
- **CLI Install**: Yes
- **Best For**: Red team phishing domain generation
- **Input**: Target domain
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: On-page keyword frequency analysis
- **Input**: URL or text
...
- **API**: Yes
- **CLI Install**: N/A
- **Best For**: Top-domain popularity and DNS trend context
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Quick domain intelligence aggregation
- **Input**: Domain or IP
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Lightweight web popularity lookups
- **Input**: Domain
...
- **API**: Yes
- **CLI Install**: N/A
- **Best For**: Competitor traffic and referral analysis
- **Input**: Domain
...
- **API**: No
- **CLI Install**: Yes
- **Best For**: CLI-based web technology fingerprinting
- **Input**: Domain or URL
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Expanding shortened links safely
- **Input**: Shortened URL
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Safe short-link destination checks
- **Input**: Shortened URL
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Resolving opaque short links
- **Input**: Shortened URL
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Tracing redirect chains for suspicious links
- **Input**: URL
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Search trend analysis and keyword research
...
- **API**: Yes
- **CLI Install**: Yes
- **Best For**: Full-scope pentest automation and recon
...
- **API**: No
- **CLI Install**: Yes
- **Best For**: Detecting exposed sensitive data on web servers
- **Input**: URLs/domains
...
- **API**: Yes
- **CLI Install**: Yes
- **Best For**: Multi-source OSINT collection automation
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: IDN and Punycode domain analysis
