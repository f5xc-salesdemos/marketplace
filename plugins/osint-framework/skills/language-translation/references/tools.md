# Language Translation — OSINT Tools Reference
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Word-level translation and bilingual dictionary lookups
...
- **API**: Yes
- **CLI Install**: N/A
- **Best For**: High-accuracy translation of documents and technical text
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Fast multi-language text translation in a browser
- **Input**: Text
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Typing non-Latin scripts and transliterated input
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Decoding internet slang and text abbreviations
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Understanding current online slang and acronym usage
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Interpreting emerging slang and culture-driven terms
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Word definitions, etymology, and multilingual term translation
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Word-level translation with conjugation and usage context
- **Input**: Words and short phrases
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Multilingual OCR extraction without account creation
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: General-purpose OCR from scanned pages and images
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: OCR conversion of scanned PDFs for editing
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Quick OCR to Word, Excel, or plain text
...
- **API**: No
- **CLI Install**: N/A
- **Best For**: Identifying unknown fonts from screenshots or photos
