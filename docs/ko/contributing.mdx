---
title: 플러그인 기여하기
description: 'f5-sales-demo 마켓플레이스용 플러그인을 생성, 구조화 및 게시하는 가이드.'
sidebar:
  order: 6
i18n:
...
<Aside type="tip" title="리포지터리 워크플로">
  ...
  전체 프로세스는 [CONTRIBUTING.md](https://github.com/f5-sales-demo/marketplace/blob/main/CONTRIBUTING.md)를 참조하십시오.
</Aside>
