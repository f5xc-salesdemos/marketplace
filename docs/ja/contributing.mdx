---
title: プラグインの貢献
description: f5-sales-demo マーケットプレイス向けプラグインの作成、構造化、公開に関するガイド。
sidebar:
  order: 6
i18n:
...
<Aside type="tip" title="リポジトリのワークフロー">
  ...
  詳細なプロセスについては [CONTRIBUTING.md](https://github.com/f5-sales-demo/marketplace/blob/main/CONTRIBUTING.md)
  を参照してください。
</Aside>
